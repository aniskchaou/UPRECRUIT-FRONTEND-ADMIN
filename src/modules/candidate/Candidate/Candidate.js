...
const Candidate = () => {
  ...
  const removeCandidateAction = (e, data) => {
    ...
    if (r) {
      ...
      candidateHTTPService.removeCandidate(data).then(data => {
        resfreshComponent()
      }).catch(e => {
          ...
          <tbody>
            ...
            {candidates.map(item =>
              <tr>
                ...
                <td>{item.phone}</td>
                <td>
                  <button type="button" data-toggle="modal" data-target="#viewCandidate" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></button>
                  ...
                  <button onClick={e => removeCandidateAction(e, item.id)} type="button" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></button></td>
              </tr>
            )}
          </tbody>
          <tfoot>
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <EditCandidate candidate={updatedItem} />
              </div>
